  ...
  const handleCalculate = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        const targetLat = -12.115;
        const targetLon = -77.036;
        const result = calculateDistance(latitude, longitude, targetLat, targetLon);
  ...
  return (
    ...
    >
      ...
      <p className="text-stone-500 font-light text-lg mb-8 max-w-sm">
        Calcula qué tan cerca estás de nuestro próximo gran proyecto inmobiliario.
      </p>
